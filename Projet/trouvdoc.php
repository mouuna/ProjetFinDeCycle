...
<body>
    ...
    $tabmedecin = $bdd->query("SELECT * FROM medecin where nomM like '%".$_POST["nomM"]."%' and specialite like '%".$_POST["special"]."%'");
    ...
    <div class="grid">
        ...
        <div class="recherche flex">
            ...
            <form action="trouvdoc.php" method="POST" class="flex espace">
        ...
        <div class="sec-grid marg">
            ...
            while ($tuple = $tabmedecin->fetch()) {
                ...
                <form action="traitdetailmed.php" method="POST">
...
<script src="app/js/rdv.js"></script>
</html>